...
<script>
  ...
  swiper.on('transitionEnd', function() {
    ...
    let currentSlideName = document.querySelectorAll('.swiper-slide')[currentSlideIndex].dataset.slidename;
    console.log(currentSlideIndex, currentSlideName)
    document.getElementById('slide-name').querySelector('a').innerHTML = currentSlideName;
    document.getElementById('slide-name').querySelector('a').dataset.accordlink = wpFeSanitizeTitle(currentSlideName)
