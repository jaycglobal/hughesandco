...
<section class="dark split-content--left" id="section-1">
  <div class="container">
    <div class="row">
      <div class="col-12 col-md-6">
        <div class="content-wrap">
        <h2 class="xl"  data-aos-once="false"  data-aos="fade-right"  data-aos-anchor-placement="bottom-bottom"  data-aos-anchor="#section-1" >Every</h2>
        
    <div class="content" data-aos-once="false"  data-aos="fade-right" data-aos-anchor-placement="bottom-bottom"   data-aos-anchor="#section-1"  data-aos-delay="500">
  ...
  <div class="container-fluid bg">
    <div class="row">
      ...
      <div class="col-12 col-md-5 bg" data-aos="fade-left" data-aos-anchor-placement="bottom-bottom"     data-aos-once="false"     data-aos-anchor="#section-1" style="background-image: url(<?php echo get_stylesheet_directory_uri(); ?>/assets/images/monaco.jpg)">
...
<section class="dark split-content--right" id="section-2">

  <div class="container-fluid bg">
    <div class="row">
      <div class="col-12 col-md-5 bg" data-aos-once="false"  data-aos="fade-right" data-aos-anchor-placement="bottom-bottom"   data-aos-anchor="#section-2">
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-12 col-md-5">
        <h2 class="xl" data-aos-once="false"  data-aos="fade-left" data-aos-anchor-placement="bottom-bottom"   data-aos-anchor="#section-2">Time</h2>
        <div class="content"  data-aos-once="false"  data-aos="fade-left" data-aos-anchor-placement="bottom-bottom"   data-aos-anchor="#section-2"  data-aos-delay="500">
...
<section class="dark split-content--left" id="section-3">
  <div class="container">
    <div class="row">
      <div class="col-12 col-md-6">
        <h2 class="xl"  data-aos-once="false"  data-aos="fade-right"  data-aos-anchor-placement="bottom-bottom"  data-aos-anchor="#section-3" >Ethos</h2>
    <div class="content" data-aos-once="false"  data-aos="fade-right" data-aos-anchor-placement="bottom-bottom"   data-aos-anchor="#section-3"  data-aos-delay="500">
...
publishing, social media, copywriting, and event 
management, which results in intelligent, multi-faceted 
and creative solutions for the companies we work with.</p>
...
<section class="dark full-width-content--left lg" id="section-4">
    <div class="container-fluid">
        <div class="row">
            <div class="col-12 col-xl-4  order-2 order-xl-1 bg bg-lg aos-init aos-animate"  data-aos="fade-right"  data-aos-once="false" data-aos-anchor-placement="center-bottom" data-aos-anchor="#section-4">
            <img  src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/section_4.jpg" alt="" class="img-left kenburns">

            </div>
            <div class="col-12 col-xl-4  order-1 order-xl-2 content aos-init aos-animate"  data-aos-once="false"  data-aos="zoom-in-right" data-aos-anchor-placement="center-bottom" data-aos-anchor="#section-4"  data-aos-delay="500"> 
                ...
                <p>Leading with confidence, we help you to navigate the myriad of marketing options available and guide you in making informed, effective decisions.  We turn your objectives into impactful, engaging and fundamentally successful campaigns, helping you reach the desired audience with efficiency.
  
  </p>
            </div>
            <div class="col-12 col-xl-4  order-3 order-xl-3 content aos-init aos-animate"  data-aos-once="false"  data-aos="zoom-in-left" data-aos-anchor-placement="center-bottom" data-aos-anchor="#section-4"  data-aos-delay="700">
                <p>
...
<section class="full">
  <div class="container">
    ...
    <div class="row">
      <div class="col-12 col-lg-4 content content-top">
        <p>Roxanne’s experience working with leading
          brands in the superyacht sector, as well as
          structuring the commercial campaigns for the
          charter and sale of superyachts, allows her to
          formulate and implement effective and tactical
          strategies that are tailored to each client. </p>
      </div>
      <div class="col-12 col-lg-4 content-img">
        <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/about.jpg" alt="">
      </div>
      <div class="col-12 col-lg-4 content content-bottom">
        <p>Ensuring the right message reaches the right
          audience, with carefully coordinated and
          cohesive campaigns, and identifying ways in
          which companies can collaborate and support
          each other to facilitate positive growth for their
          respective businesses, has earned Roxanne a
          respected reputation.</p>
      </div>
    </div>
  </div>
</section>
...
<section class="accordion full" style="background-image: url(<?php echo get_stylesheet_directory_uri(); ?>/assets/images/services.jpg)">
    ...
    <div class="row">
      <div class="col-12">
        <h3 class="jumbo light text-left">Services</h3>

      </div>
    </div>
      <div class="row accordion-row">
        <div class="col-12 col-md-6 col-lg-4 accord main-accord">
        ...
        <div class="col-12 col-md-6 col-lg-4 accord">
          <div class="accord-wrap h-100">
            ...
            <svg class="accord-activate" xmlns="http://www.w3.org/2000/svg" width="51" height="50" viewBox="0 0 51 50"><g id="Group_129" data-name="Group 129" transform="translate(-1115 -5884)"><rect id="Rectangle_129" class="vertical" data-name="Rectangle 129" width="5" height="50" rx="2.5" transform="translate(1138 5884)" fill="#fff" /><rect id="Rectangle_133" class="horizontal" data-name="Rectangle 133" width="5" height="51" rx="2.5" transform="translate(1115 5912) rotate(-90)" fill="#fff" /></g></svg>
            <div class="accord-content">
              <div class="wrap">
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quae quas, veniam neque facilis quaerat nemo sint earum animi quo rem hic quod ipsam nesciunt dolorem consectetur omnis eaque praesentium odio.</p>
              </div>
